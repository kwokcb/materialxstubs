...
def flattenFilenames(doc: MaterialX.PyMaterialXCore.Document, searchPath: FileSearchPath = ..., customResolver: MaterialX.PyMaterialXCore.StringResolver = ...) -> None:
    """flattenFilenames(doc: MaterialX.PyMaterialXCore.Document, searchPath: MaterialX.PyMaterialXFormat.FileSearchPath = <MaterialX.PyMaterialXFormat.FileSearchPath object at 0x0000027D023AE570>, customResolver: MaterialX.PyMaterialXCore.StringResolver = None) -> None"""
...
def loadLibrary(file: FilePath, doc: MaterialX.PyMaterialXCore.Document, searchPath: FileSearchPath = ..., readOptions: XmlReadOptions = ...) -> None:
    """loadLibrary(file: MaterialX.PyMaterialXFormat.FilePath, doc: MaterialX.PyMaterialXCore.Document, searchPath: MaterialX.PyMaterialXFormat.FileSearchPath = <MaterialX.PyMaterialXFormat.FileSearchPath object at 0x0000027D01EF3830>, readOptions: MaterialX.PyMaterialXFormat.XmlReadOptions = None) -> None"""
...
def readFromXmlFileBase(doc: MaterialX.PyMaterialXCore.Document, filename: FilePath, searchPath: FileSearchPath = ..., readOptions: XmlReadOptions = ...) -> None:
    """readFromXmlFileBase(doc: MaterialX.PyMaterialXCore.Document, filename: MaterialX.PyMaterialXFormat.FilePath, searchPath: MaterialX.PyMaterialXFormat.FileSearchPath = <MaterialX.PyMaterialXFormat.FileSearchPath object at 0x0000027D022E82B0>, readOptions: MaterialX.PyMaterialXFormat.XmlReadOptions = None) -> None"""
def readFromXmlString(doc: MaterialX.PyMaterialXCore.Document, str: str, searchPath: FileSearchPath = ..., readOptions: XmlReadOptions = ...) -> None:
    """readFromXmlString(doc: MaterialX.PyMaterialXCore.Document, str: str, searchPath: MaterialX.PyMaterialXFormat.FileSearchPath = <MaterialX.PyMaterialXFormat.FileSearchPath object at 0x0000027D0177E0F0>, readOptions: MaterialX.PyMaterialXFormat.XmlReadOptions = None) -> None"""
